...
def front_process(img,size):
    ...
    cheque_ocr,cheque_detect,payee_ocr,payee_detect,ac_ocr,ac_detect = process_image(img,size)
    date_list,amount_list,bottom,bank_name=create_partitions(cheque_ocr,cheque_detect,size)
    date,amount,bank,ifsc,payee_name,payee_amt,ac,leaf_no=extract_details(payee_ocr,ac_ocr,cheque_ocr,date_list,amount_list,bottom,bank_name)
